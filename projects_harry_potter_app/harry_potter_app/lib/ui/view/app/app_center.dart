...
import 'package:harry_potter_app/ui/view/app/app_center_views/favorites_view.dart';
import 'package:harry_potter_app/ui/view/app/app_center_views/featured_view.dart';
import 'package:harry_potter_app/ui/view/app/app_center_views/items_view.dart';
import 'package:harry_potter_app/ui/view/app/app_center_views/search_view.dart';
import 'package:harry_potter_app/ui/view/app/app_center_views/welcome_view.dart';
import 'package:harry_potter_app/utilities/dialogs/log_out_dialog.dart';
...
class _AppCenterState extends State<AppCenter> {
  ...
  void initState() {
    print('here0000');
    context.read<AppBloc>().add(AppEventGoToWelcome());
    super.initState();
  }
        ...
        children: [
          ...
          BlocConsumer<AppBloc, AppState>(
            ...
            builder: (context, state) {
              ...
              } else if (state is AppStateOnFavoritesView) {
                return FavoritesView(state: state);
              } else if (state is AppStateOnSearchView) {
                return const SearchView();
              } else if (state is AppStateOnFeaturedView) {
                return FeaturedView(state: state);
              } else {

...
class AppStateWelcome extends AppState {
  AppStateWelcome({super.appBarTitle = AppConstants.welcome});
}
...
class AppStateOnFeaturedView extends AppState {
  final Map<Book, int> featuredBooks;
  final Map<Character, int> featuredCharacters;
  final Map<Spell, int> featuredSpells;
  final Map<Species, int> featuredSpecies;

  AppStateOnFeaturedView({
    super.appBarTitle = AppConstants.featured,
    required this.featuredBooks,
    required this.featuredCharacters,
    required this.featuredSpells,
    required this.featuredSpecies,
  });
}
...
// Todo lo que sea constante e invariable lo definimos aquí en la medida de los posible
// para en el AppBloc únicamente pasar como parámetro variables cambiantes
// p.e: Si invoco la navegación a favoritos, el AppBarTitle va a ser siempre el 
// mismo, así que preferible definirlo aquí (pendiente de cambiar eso)

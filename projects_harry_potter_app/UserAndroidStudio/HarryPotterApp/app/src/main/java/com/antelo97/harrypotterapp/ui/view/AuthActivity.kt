...
class AuthActivity /*@Inject constructor(private val repository: UserRepository)*/ :
    AppCompatActivity() {
    ...
    private fun showRightSignUpDialog(email: String) {
        ...
        builder.setPositiveButton("Accept") { _, _ ->
            ...
            mainViewModel.viewModelScope.launch {
                mainViewModel.insertUser(FirebaseAuth.getInstance().currentUser!!)
            }

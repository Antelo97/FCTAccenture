...
class CharactersViewHolder(
    ...
    fun render(character: com.antelo97.harrypotterapp.domain.model.Character, position: Int) {
        itemCharacterBinding.tvCharacterName.text = character.getName()
        itemCharacterBinding.tvCharacterDetails.text =
            "\n   \u2022 Species: " + character.getSpecies() + "\n" +
                    "   \u2022 Gender: " + character.getGender() + "\n" +
                    "   \u2022 House: " + character.getHouse() + "\n" +
                    "   \u2022 Year of birth: " + character.getYearOfBirth() + "\n" +
                    "   \u2022 Is wizard?: " + character.isWizard() + "\n" +
                    "   \u2022 Ancestry: " + character.getAncestry() + "\n" +
                    "   \u2022 Patronus: " + character.getPatronus() + "\n" +
                    "   \u2022 Actor: " + character.getActor() + "\n" +
                    "   \u2022 Wand:\n" +
                    "       - Wood: " + character.getWand().getWood() + "\n" +
                    "       - Core: " + character.getWand().getCore() + "\n" +
                    "       - Length: " + character.getWand().getLength() + "\n\n\n\n\n"
        Picasso.get().load(character.getImageUrl()).into(itemCharacterBinding.ivCharacter)

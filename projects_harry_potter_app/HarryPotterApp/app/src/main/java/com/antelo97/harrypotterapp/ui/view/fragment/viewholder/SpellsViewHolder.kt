...
class SpellsViewHolder(
    ...
    fun render(spell: Spell, position: Int) {
        itemSpellBinding.tvSpellName.text = spell.name
        itemSpellBinding.tvSpellDetails.text = spell.description
        Picasso.get().load(spell.imageUrl).into(itemSpellBinding.ivSpell)

...
class CharacterRepository @Inject constructor(
    ...
    suspend fun updateCharacter(character: com.antelo97.harrypotterapp.domain.model.Character) {
        dao.updateCharacter(character.toDatabase())
    }

    suspend fun updateCharacters(characters: List<com.antelo97.harrypotterapp.domain.model.Character>) {
        dao.updateCharacters(characters.map { it.toDatabase() })
    }
}